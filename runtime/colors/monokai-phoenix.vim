...
" Messages
" --------------------------
hi Question guifg=#000000 guibg=NONE gui=NONE ctermfg=0 ctermbg=NONE cterm=NONE
...
hi Title guifg=#000000 guibg=NONE gui=NONE ctermfg=25 ctermbg=NONE cterm=NONE
...
if has("nvim")
  ...
  " Neovim Terminal
  " --------------------------
  hi TermCursor guifg=#000000 guibg=NONE gui=NONE ctermfg=233 ctermbg=NONE cterm=NONE
  hi TermCursorNC guifg=#000000 guibg=NONE gui=NONE ctermfg=233 ctermbg=NONE cterm=NONE

endif

" General Highlighting
" --------------------------
hi Constant guifg=#000000 guibg=NONE gui=NONE ctermfg=141 ctermbg=NONE cterm=NONE
hi Number guifg=#000000 guibg=NONE gui=NONE ctermfg=201 ctermbg=NONE cterm=NONE
hi Float guifg=#000000 guibg=NONE gui=NONE ctermfg=201 ctermbg=NONE cterm=NONE
hi Boolean guifg=#000000 guibg=NONE gui=NONE ctermfg=29 ctermbg=NONE cterm=NONE
hi Character guifg=#000000 guibg=NONE gui=NONE ctermfg=27 ctermbg=NONE cterm=NONE
hi String guifg=#000000 guibg=NONE gui=NONE ctermfg=226 ctermbg=NONE cterm=NONE
hi Type guifg=#000000 guibg=NONE gui=NONE ctermfg=148 ctermbg=NONE cterm=NONE
hi Structure guifg=#000000 guibg=NONE gui=NONE ctermfg=201 ctermbg=NONE cterm=NONE
hi StorageClass guifg=#000000 guibg=NONE gui=NONE ctermfg=0 ctermbg=NONE cterm=NONE
hi TypeDef guifg=#000000 guibg=NONE gui=NONE ctermfg=0 ctermbg=NONE cterm=NONE
hi Identifier guifg=#000000 guibg=NONE gui=NONE ctermfg=5 ctermbg=NONE cterm=NONE
hi Function guifg=#000000 guibg=NONE gui=NONE ctermfg=0 ctermbg=NONE cterm=NONE
hi Statement guifg=#000000 guibg=NONE gui=NONE ctermfg=0 ctermbg=NONE cterm=NONE
hi Operator guifg=#000000 guibg=NONE gui=NONE ctermfg=201 ctermbg=NONE cterm=NONE
hi Label guifg=#000000 guibg=NONE gui=NONE ctermfg=0 ctermbg=NONE cterm=NONE
hi Keyword guifg=#000000 guibg=NONE gui=NONE ctermfg=81 ctermbg=NONE cterm=NONE
hi Preproc guifg=#000000 guibg=NONE gui=NONE ctermfg=201 ctermbg=NONE cterm=NONE
hi Include guifg=#000000 guibg=NONE gui=NONE ctermfg=201 ctermbg=NONE cterm=NONE
hi Define guifg=#000000 guibg=NONE gui=NONE ctermfg=201 ctermbg=NONE cterm=NONE
hi Macro guifg=#000000 guibg=NONE gui=NONE ctermfg=0 ctermbg=NONE cterm=NONE
hi PreCondit guifg=#000000 guibg=NONE gui=NONE ctermfg=0 ctermbg=NONE cterm=NONE
hi Special guifg=#000000 guibg=NONE gui=NONE ctermfg=0 ctermbg=NONE cterm=NONE
hi SpecialChar guifg=#000000 guibg=NONE gui=NONE ctermfg=201 ctermbg=NONE cterm=NONE
hi Delimiter guifg=#000000 guibg=NONE gui=NONE ctermfg=197 ctermbg=NONE cterm=NONE
hi Comment guifg=#000000 guibg=NONE gui=italic ctermfg=197 ctermbg=NONE cterm=italic
hi SpecialComment guifg=#000000 guibg=NONE gui=NONE ctermfg=197 ctermbg=NONE cterm=NONE
hi Tag guifg=#000000 guibg=NONE gui=NONE ctermfg=197 ctermbg=NONE cterm=NONE
hi Underlined guifg=#000000 guibg=NONE gui=NONE ctermfg=197 ctermbg=NONE cterm=NONE
hi Ignore guifg=#000000 guibg=NONE gui=NONE ctermfg=197 ctermbg=NONE cterm=NONE
hi Todo guifg=#000000 guibg=NONE gui=bold ctermfg=197 ctermbg=233 cterm=bold
...
function! s:javascriptMonokaiPhoenixFiletype()
  ...
  hi jsLineComment guifg=#000000 guibg=NONE gui=italic ctermfg=0 ctermbg=NONE cterm=italic
  hi jsEnvComment guifg=#000000 guibg=NONE gui=italic ctermfg=201 ctermbg=NONE cterm=italic
  hi jsCvsTag guifg=#000000 guibg=NONE gui=italic ctermfg=201 ctermbg=NONE cterm=italic
  hi jsComment guifg=#000000 guibg=NONE gui=italic ctermfg=201 ctermbg=NONE cterm=italic
  hi jsBlockComment guifg=#000000 guibg=NONE gui=italic ctermfg=201 ctermbg=NONE cterm=italic
  ...
  hi javaScriptMethodCallWithArgs guifg=#000000 guibg=NONE gui=NONE ctermfg=0 ctermbg=NONE cterm=NONE
